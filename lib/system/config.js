...
global.header = `ᴏʜᴍʏɴᴇxᴜꜱ v${require('package.json').version} ᴍᴀᴅᴇ ɪɴ ᴊᴀᴡᴀ`
global.footer = 'ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ᴀᴅᴅʏᴋᴇᴄᴇ ッ'
global.status = Object.freeze({
   wait: Func.Styles('Processed . . .'),
   invalid: Func.Styles('URL is Invalid!'),
   wrong: Func.Styles('Wrong format!'),
   getdata: Func.Styles('Scraping metadata . . .'),
