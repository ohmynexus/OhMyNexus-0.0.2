module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = 'addykece'
      ...
      if (!('owners' in setting)) setting.owners = ['6282177779477', '6282135930493']
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/f02511798bc638a249e5a.png'
      if (!('link' in setting)) setting.link = 'https://www.instagram.com/addykece_/'
      ...
      global.db.setting = {
         ...
         verify: false,
         onlyprefix: '+',
         owners: ['6282177779477', '6282135930493'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp. *You can download posts from various social media just by sending the link.*\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/neoxr/neoxr-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 2,
         cover: 'https://telegra.ph/file/f02511798bc638a249e5a.png',
         link: 'https://www.instagram.com/addykece_/',
         quizset: []
      }
   }
}
