neoxr.create(async (m, {
   ...
   try {
      ...
      if (groupSet.antilink && !isAdmin && body) {
         // !body.includes(await client.groupInviteCode(m.chat))
         if (body.match(/(chat.whatsapp.com|wa.me)/gi)) return client.sendMessage(m.chat, {
            delete: {
               remoteJid: m.chat,
               fromMe: false,
               id: m.key.id,
